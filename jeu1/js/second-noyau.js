...
class CoreSystem {
    ...
    constructor() {
        ...
        this.correctCommand = 'EXE -C-734 -KEY-42-CARTE';
        ...
        this.timeLeft = 60; // 40 secondes pour réussir
    ...
    startGlitchEffect() {
        ...
        }, 5000); // Une corruption toutes les 5 secondes
    ...
    endGame(isSuccess) {
        ...
        if (isSuccess) {
            ...
            this.errorEl.textContent = "TEMPS ÉCOULÉ. VÉROUILLAGE DU NOYAU.";

            this.timerEl.textContent = "Temps restant : 0s";

            setTimeout(() => window.location.href = 'echec.html', 2000);
